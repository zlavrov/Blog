...
class Blog
{
    ...
    public function getIconBlog(): ?string
    {
        return $this->icon_blog;
    }

    public function setIconBlog(?string $icon_blog): self
    {
