...
class Article
{
    ...
    private ?string $icon_article = null;
    ...
    public function getIconArticle(): ?string
    {
        return $this->icon_article;
    }

    public function setIconArticle(?string $icon_article): self
    {
        $this->icon_article = $icon_article;
