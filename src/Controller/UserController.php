...
class UserController extends AbstractController {
    ...
    #[Route('/user/{id}', name: 'update_user', requirements: ['id' => '\d+'], methods: ['PATCH'])]
    ...
    #[Route('/user/{id}', name: 'get_user_by_id', requirements: ['id' => '\d+'], methods: ['GET'])]
    ...
    #[Route('/user/name/{name}', name: 'get_user_by_name', methods: ['GET'])]
    ...
    #[Route('/user/list', name: 'get_user_list', methods: ['GET'])]
    ...
    #[Route('/user/{id}', name: 'delete_user', requirements: ['id' => '\d+'], methods: ['DELETE'])]
    ...
    #[Route('/create/user', name: 'show_user_post_form', methods: ['GET'])]
    public function showUserPostForm(): Response
    {
        return $this->render('user/index.html.twig', [
            'controller_name' => 'UserController',
        ]);
    ...
    #[Route('/update/user', name: 'show_user_patch_form', methods: ['GET'])]
    public function showUserPatchForm(): Response
    {
        return $this->render('user/index.html.twig', [
            'controller_name' => 'UserController',
        ]);
