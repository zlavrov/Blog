...
class CommentController extends AbstractController {
    ...
    #[Route('/api/comment/{id}', name: 'update_comment', requirements: ['id' => '\d+'], methods: ['PATCH'])]
    ...
    #[Route('/api/comment/{id}', name: 'get_comment_by_id', requirements: ['id' => '\d+'], methods: ['GET'])]
    ...
    #[Route('/api/comment/{id}', name: 'delete_comment', requirements: ['id' => '\d+'], methods: ['DELETE'])]
