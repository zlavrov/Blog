...
class ArticleController extends AbstractController {
    ...
    #[Route('/article/{id}', name: 'update_article', requirements: ['id' => '\d+'], methods: ['PATCH'])]
    ...
    #[Route('/article/{id}', name: 'get_article_by_id', requirements: ['id' => '\d+'], methods: ['GET'])]
    ...
    #[Route('/article/title/{title}', name: 'get_article_by_title', methods: ['GET'])]
    ...
    #[Route('/article/list', name: 'get_article_list', methods: ['GET'])]
    ...
    #[Route('/article/{id}', name: 'delete_article', requirements: ['id' => '\d+'], methods: ['DELETE'])]
    ...
    #[Route('/create/article', name: 'show_article_post_form', methods: ['GET'])]
    public function showArticlePostForm(): Response
    {
        return $this->render('article/index.html.twig', [
            'controller_name' => 'ArticleController',
        ]);
    ...
    #[Route('/update/article', name: 'show_article_patch_form', methods: ['GET'])]
    public function showArticlePatchForm(): Response
    {
        return $this->render('article/index.html.twig', [
            'controller_name' => 'ArticleController',
        ]);
